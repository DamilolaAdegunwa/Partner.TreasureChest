...
//        public ReflectionCoder()
//        {
//            var filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ReflectionCoders\\Template", "RazorDto.txt");
//            RazorDto = File.ReadAllText(filePath);

//            filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ReflectionCoders\\Template", "RazorAppService.txt");
//            RazorAppService = File.ReadAllText(filePath);

//            filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ReflectionCoders\\Template", "IRazorAppService.txt");
//            IRazorAppService = File.ReadAllText(filePath);

//            filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ReflectionCoders\\Template", "RazorController.txt");
//            RazorController = File.ReadAllText(filePath);

//            filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "ReflectionCoders\\Template", "RazorView.txt");
